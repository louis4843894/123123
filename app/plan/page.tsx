...
export default function PlanPage() {
  ...
  const selectedItems = useMemo(
    () => SERVICE_ITEMS.filter(i => selected.has(i.id)),
    [selected]
  )
                          ...
                          return (
                            <button
                              ...
                              className={`w-full flex items-start gap-4 px-5 py-4 text-left transition-colors ${
                                item.required ? 'cursor-default' : 'hover:bg-muted/20'
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="flex items-center gap-2 mb-0.5">
                                  ...
                                  {item.required && (
                                    <span className="text-xs text-muted-foreground">✦ 必選</span>
                                  )}
                                </div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mb-3">
                        <button
                          ...
                          className="w-8 h-8 rounded-lg border border-border flex items-center justify-center hover:bg-muted/40 text-sm"
                        >
                          -
                        </button>
